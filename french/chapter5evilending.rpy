...
translate french evilending_dabbfd50:
    ...
    m "J'ai regardé Reza ajuster sa prise sur la boite avant de la lâcher. J'ai fouillé dans ma poche."
...
translate french evilending_89daf031:
    ...
    # c "Yes, Reza. We did."
    c "Oui Reza, nous l'aurons mérité."
...
translate french evilending_d3f8c098:
    ...
    c "Je n'ai qu'une question qui me vient à l'esprit maintenant : Pourquoi je partagerai tout ça avec toi ?"
...
translate french evilending_bfb60130:
    ...
    m "Immédiatement, son visage fut marqué d'une expression de dégoût alors qu'il laissait tomber la boite pour s'emparer précipitement de son arme."
...
translate french evilending_32568256:
    ...
    m "De mon côté, avant même qu'il n'ai eut le temps de chercher son arme, j'avais déjà un doigt paré posé sur la détente de mon revolver, ou plutôt de la copie de sa propre arme."
...
translate french evilending_b72c2187:
    ...
    m "Tandis qu'il essayait encore de sortir son arme de sa poche, je lui ai tiré dans le bras. Il a alors laissé tombé son revolver, que j'ai écarté d'un coup de pied. Reza était là devant moi, affalé contre le mur derrière lui et se tordant de douleur."
...
translate french evilending_4d4e95ab:
    ...
    m "Quand il s'est rendu compte que je le poitais toujours, il a levé la main de son bras valide."
...
translate french evilending_dab815b3:
    ...
    c "Tu n'as qu'à voir leur technologie. Tu étais prêt à gâcher tout ça, et pour quoi ? Pour de la gloire et de l'argent ? Pour être vu comme un héros au yeux des nôtres ? Mais au final, tu aurais juste retardé la mort de notre race."
...
translate french evilending_3a11d3e0:
    ...
    c "Tu t'es toujours caché derrière ton idéalisme exemplaire, Reza. Mais quand on y regarde de plus près, c'est toujours toi qui a le plus a gagner."
...
translate french evilending_a33aae66:
    ...
    c "Ça n'aurait pas été difficile de couper le contact avec les dragons en attendant que la comète fasse son affaire. Sans eux, il n'aurait resté qu'une personne succeptible de me balancer."
...
translate french evilending_cc81ed0c:
    ...
    Rz "J'aurais pu te laisser tomber comme une merde. Mais j'avais confiance en toi !"
...
translate french evilending_b69213ba:
    ...
    Rz "En fait dès le départ je n'ai pas eu besoin de toi. J'ai fait le plus gros du travail, et toi tu es là pour tout me prendre. Tu ne mérites rien de tout ce qui t'attends de l'autre côté."
